...
'''--rank 1 --train 0 --load 1 --model_name NCR --model_path model/NCR/0.3653_0.4254_0.5287_0.7144best_test.model 
--dataset ml100k01-1-5 --metric ndcg@5,ndcg@10,hit@5,hit@10 
--max_his 5 --test_neg_n 100 --l2 1e-4 --r_weight 0.1 --random_seed 2022 --gpu 0
'''
...
def main():
    ...
    args.train = 0
    args.load = 1
    args.model_path = 'saved_model/NCR/0.3653_0.4254_0.5287_0.7144best_test.model'
    args.dataset = 'ml100k01-1-5'
    args.metric = 'ndcg@5,ndcg@10,hit@5,hit@10'
    args.max_his = 5
    args.test_neg_n = 100
    args.l2 = 1e-4
    args.r_weight = 0.1
