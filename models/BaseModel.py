...
class BaseModel(paddle.nn.Layer):
    """
    Base saved_model, the following methods need to be overridden.
    parse_model_args,
    __init__,
    _init_weights,
    predict,
    ...
    def parse_model_args(parser, model_name='BaseModel'):
        """
        parse saved_model related arguments
        :param parser: parser object, which is from main() method
        :param model_name: saved_model name
        :return:
        """
        parser.add_argument('--model_path', type=str, default=\
            '../saved_model/%s/%s.pdiparams' % (model_name, model_name), help=\
            'Model save path.')
        return parser
    ...
    def init_paras(m):
        """
        Initialize saved_model parameters
        :param m: saved_model parameters
        :return:
        """
    ...
    def __init__(self, label_min, label_max, feature_num, random_seed=2018, model_path='./saved_model/Model/Model.pdiparams'):
    ...
    def count_variables(self):
        """
        count number of parameters in the saved_model
        :return:
        """
    ...
    def save_model(self, model_path=None):
        ...
        logging.info('Save saved_model to ' + model_path)
    ...
    def load_model(self, model_path=None):
        ...
        self.eval()
        logging.info('Load saved_model from ' + model_path)
