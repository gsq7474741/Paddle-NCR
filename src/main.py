...
def main():
    ...
    if args.model_path == '../model/%s/%s.pdiparams' % (init_args.model_name, init_args.model_name):
        args.model_path = '../model/%s/%s.pdiparams' % (init_args.model_name, log_file_name)
